  ...
  (0, _createClass2.default)(TextLayerItemInternal, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          text = _this$props2.str; //console.log("PDFJS", page.commonObjs);

      var viewport = page.getViewport(scale);
      page.getTextContent().then(function (textContent) {
        //console.log("TEXT CONTENT", textContent);
        var textLayer = _pdfjsDist.default.renderTextLayer({
      ...
      }); //console.debug("FONT NAME", fontName);
      //const fontData = this.getFontData(fontName).then(fontData => {
      //    console.debug("FONT DATA", fontData);
      //});
